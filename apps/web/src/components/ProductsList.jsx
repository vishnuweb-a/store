  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`}>
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm glass-card border-0 text-gray-900 overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
          <div className="relative">
            ...
            {product.ribbon_text && (
              <div className="absolute top-3 left-3 bg-pink-500/90 text-gray-900 text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                {product.ribbon_text}
              </div>
            )}
            <div className="absolute top-3 right-3 bg-purple-500/80 text-gray-900 text-xs font-bold px-3 py-1 rounded-full flex items-baseline gap-1.5">
              {hasSale && (
          ...
          <div className="p-4">
            ...
            <p className="text-sm text-gray-900 h-10 overflow-hidden">{product.subtitle || 'Check out this amazing product!'}</p>
